# Covid-19-Vaccine-Wastage---ICBAI-2021
An Indian District Level Case Study
...
• Identified high and low performing centers using data analysis and visualization
• Used Excel and Tableau for trend analysis, mapping, and insights
• Designed actionable operational recommendations such as
• Consolidation of underperforming centers
• Optimized session sizing to reduce open vial wastage
...
• Tableau dashboards and geographic visualization
• Operations research and industrial engineering principles
• Public health analytics and policy driven decision making

Impact

The findings demonstrate how data driven micro planning at the district level can lead to meaningful reductions in vaccine wastage, cost savings, and better public health outcomes. While the study focuses on a single district, the framework and insights are scalable and applicable to larger regions.
